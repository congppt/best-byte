    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "GE",
                "LE",
                name="speccomparisionoperator",
                native_enum=False,
            ),
            nullable=False,
        ),
        sa.CheckConstraint(
            "left_id != right_id", name=op.f("ck_spec_comparision_self_comparison")
        ),
        sa.ForeignKeyConstraint(
            ["left_id"], ["spec.id"], name=op.f("fk_spec_comparision_[left_id]_spec")
        ),
        sa.ForeignKeyConstraint(
            ["right_id"], ["spec.id"], name=op.f("fk_spec_comparision_[right_id]_spec")
        ),
        sa.PrimaryKeyConstraint(
            "left_id", "right_id", name=op.f("pk_spec_comparision")
        ),
    )
